...
<body>
    <div class="container">
        <div class="logo-section">
            ...
            <p class="subtitle">Permintaan reset password untuk akun Anda</p>
        </div>
        
        <div class="greeting">
            Halo <strong>{{ $userName }}</strong>,<br><br>
            Kami menerima permintaan untuk mereset password akun Anda di <strong>Metland Recruitment</strong>. Gunakan kode OTP di bawah ini untuk melanjutkan proses reset password.
        </div>
        ...
        <div class="info-section">
            ...
            <ul class="info-list">
                <li>Masukkan 6 digit kode di atas pada halaman reset password</li>
        ...
        <div class="warning">
            ...
            <p class="warning-text">
                Jika Anda tidak melakukan permintaan reset password, abaikan email ini dan password Anda akan tetap aman. 
